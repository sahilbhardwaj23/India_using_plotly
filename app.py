...
st.write("Our project aims to provide an interactive platform for exploring key socio-economic indicators across different states of India."
...
st.sidebar.title('Interactive Data Visualization')
